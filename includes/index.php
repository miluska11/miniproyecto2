    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <form class="form" action="process-registration.php" method="post" id="signup-form">
                    <label>
                ...
                <p> Already a Member? <a class="directorio" href="/acceso.php">Login</a> </p>
            </div>
        </div>
    </div>
